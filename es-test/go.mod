module pkg/github.com/pritamdas99/awesomeproject/es-test
...
require (
	...
	kubedb.dev/apimachinery v0.51.1-0.20250130132025-f435670c9a41
	kubedb.dev/db-client-go v0.6.1-0.20250206120031-0275a8e808ea
